...
protected:
    ...
    virtual void addDebugSignpost(std::optional<std::size_t>, const char*) {}
...
public:
    ...
    DebugGroup<RenderPass> createDebugGroup(std::optional<std::size_t> threadIndex, const char* name) {
