...
public:
    HTTPRequest(HTTPFileSource::Impl *, Resource, FileSource::CopyableCallback<void(Response)>);
...
HTTPRequest::HTTPRequest(HTTPFileSource::Impl *context_, Resource resource_, FileSource::CopyableCallback<void(Response)> callback_)
    : context(context_),
